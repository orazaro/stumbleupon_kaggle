...
# -*- coding: utf-8 -*-
"""
    Model 13 ==  Model 08 with new driver 
"""
...
class Model13(BaseEstimator):
  def __init__(self):
    pass
  def fit(self, Xmask, y):
    pr = prepare.Prepare_0(model=13, n_components=128, min_df=3, preproc=0, 
    ...
    clf = lm.LogisticRegression(penalty='l1', dual=False, tol=0.00001, 
